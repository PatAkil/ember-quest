...
| The programme stalls: nothing new is playable until P5's first build — 12–24 sessions, 9–19 weeks at the measured pace — and the P1 and P2 stops ask about sizes | The demo stays live as the only playable, an accepted cost stated in "What stands still"; each stop also asks whether the owner still wants the game; the absence protocol | a month with no session |
