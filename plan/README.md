...
**Status: revision 16, under review (2026-09-12).** This folder is the plan for building
...
agents in fourteen rounds (112, 97, 73, 71, 55, 59, 69, 62, 59, 72, 73, 56, 52 and 51 findings;
...
is revision 16, after round 14, whose two blocking findings were two mechanisms of the
plan's own making — the environment image's hand-back rebuilt on its own artifact and
never converged, and the device runner's ledger rows had neither a permission nor a venue
— and whose twenty-two gaps ran from the tier the testers see (its bar was measured on a
scene P5 never draws) to the app icon nobody was drawing; every one is resolved here. A read-only consistency pass over the four documents precedes
...
6. **What it costs and what stands still** (below): about 14–28 sessions of agent
   ...
   figure here) — on a calendar whose floor is the owner's forty-four to fifty-one review
   sittings up to the first test-track build (fifty-seven to sixty-six over the programme)
   plus the stores' four weeks after it, about **thirteen to fourteen weeks at three or
   more sessions a week**, **thirteen to nineteen at two a week and nineteen to
   thirty-eight at one** — the one to two a week this review measured on the owner's
   current subscription, the best case needing a second seat or a higher tier the money
   table prices; the owner's own time is about 55–120 hours of review sittings, 15–25
...
`FUNCTIONAL.md` § F4.3, § F5); without the scene phase 17–34 of capacity; the web stretch adds 1–2 and question 2's portrait branch 4.5–6.5, the calendar moving with either; two contingent items sit outside every band — the felt-row worst case, up to 2–4 sessions at P5 (`FUNCTIONAL.md` § F1.5), and P7's blockers beyond the first, an S each (the P7 row). The critical path
...
phases need P0 ≈ 6 (the spike reports, the art tool and the captured assets, the critic's
protocol and baselines, the calibration's adjudication, the prototype commits, the look
decision), P1 ≈ 8 (about fifteen pull requests), P2 ≈ 8–11, P3 ≈ 6–8, P4 ≈ 12, P5 ≈ 8–12,
P6 ≈ 6, P7 ≈ 3 — **about sixty sittings** (57–66), which at those lengths is **about
55–120 hours** of review; beyond the sittings the owner's admin, store and recruitment
...
the testers, the weekly channel, App Review's questions — is about **15–25 hours** over
...
than about nine to ten weeks (the 44–51 sittings of P0–P4 and P5's first half precede it,
one a day) and P7 not in fewer than about **thirteen to fourteen weeks** — the best case,
...
review measured** the first term binds instead: about thirteen to nineteen weeks at two a
week (the review floor still binds at its low end), nineteen to thirty-eight at one, and
a year or more below one — and P1's stop is taken on the measured real session, not on
this extrapolation from review rounds. A fourth
...
|---|---|---|
| Agent compute | — | the owner's Claude subscription — the Max-class tier this review ran on, assumed at ≈ $100–200 a month for the arithmetic and recorded exactly here at P0, with whether the tier can rise and whether a second seat is permitted — the three-or-more-sessions branch exists only if one of them is — whose *n* sessions a week is the calendar's first term; this review hit its weekly limit twice, which is the measured case of about one to two sessions a week, and a higher tier or a second seat raises *n* at roughly the same again per month, which the best-case calendar assumes and the programme total prices as its three-or-more-sessions branch; a session of this size at API list prices would cost about ten times the month's subscription — the ratio is measured on one real session after P1 and recorded here, not guessed |
...
| P4 | says yes or no to 43 contact sheets on a phone, in the order of `FUNCTIONAL.md` § F3.5 (a few minutes each, batched per pack into about twelve pull requests), and takes the stop decisions (`FUNCTIONAL.md` § F3.5's second and third). An absent owner stalls the cast and, under a subscription winner, burns a paid month |
...
return. An absence costs calendar, never rework — with two exceptions, the closed test,
...
| The programme stalls: nothing new is playable until P5's first build — 14–28 sessions of capacity, 9–28 weeks at the measured pace — and the P1 and P2 stops ask about sizes | The demo stays live as the only playable, an accepted cost stated in "What stands still"; each stop also asks whether the owner still wants the game; the absence protocol | a month with no session |
...
5. **The device lane (D18)** — closes at P1. A self-hosted runner on the owner's machine in
   ...
   it returns — the phones the owner already holds, about half a session to set up — it must be a Mac for the iPhone lane, which the
...
8. **The repository (D2)** — closes at P0's start, before the move commit, two parts. (a) *Where*: the prototype under
   ...
   *Visibility*: public, as today (recommended: the hosted runners, the arm64 leg, Pages
   ...
   a month at the measured pace; plus Pro's ≈ $4 a month), the arm64 leg metered at $0.005 a
