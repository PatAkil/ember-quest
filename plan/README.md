...
10. **Enforcement is by machines where a machine can do it, and the plan says where it
    ...
    owned-path check exists, the edit hook, the git hooks, the review bundle and the critic
