...
failing on an owned path without the owner's review on the head commit, passing once the
review is given without a new push, and unweakened by a head-branch edit to the check's
own workflow → Spotless and detekt
